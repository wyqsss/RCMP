...
class DQN(object):
    ...
    def learn(self, s, a, r, s_):
        ...
        # print(q_target)
        # print(b_a)
        # q_target = b_r + GAMMA * torch.max(q_next)  # shape (batch, 1)
        q_target[b_a] = b_r + GAMMA * torch.max(q_next)
        
        # print(f"qt is {q_target}, qe is {q_eval}")
        ...
        nn.utils.clip_grad_norm_(self.eval_net.parameters(), 10)
        self.optimizer.step()
